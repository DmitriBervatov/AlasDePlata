...
const Reservations = () => {
  return (
    <div className="container mx-auto">
      <div>
        <h1>Reservar</h1>
        <span>Encuentra y reserva tu próximo viaje con Alas de Plata</span>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        <Tabs defaultValue="fly" className="w-full">
          <TabsList className="w-full grid grid-cols-4 bg-muted/50 p-0 h-auto">
            <TabsTrigger
              value="fly"
              className="border-0 data-[state=active]:bg-white rounded-none border-b-2 border-transparent data-[state=active]:border-primary py-4"
            >
